...
class ClientFeatures(BaseModel):
    ...
    # Services internet (3e modalité = "No internet service")
...
class BatchPredictionRequest(BaseModel):
    """N-client batch input (1 à 1000 clients par requête)."""
...
class ModelInfoResponse(BaseModel):
    """Manifest passthrough — reflète artifacts/manifest.json."""
    model_name: str
    threshold: float
    trained_at: str
    sklearn_version: str
